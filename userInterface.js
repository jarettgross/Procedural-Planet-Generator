document.addEventListener('DOMContentLoaded', function() {
	...
	if (!document.getElementById("triangles").checked) {
		...
		document.getElementById("tessellations").value = 3;
		document.getElementById("tessellations-value").textContent = 3;
	}
	...
	function changeHandler(event) {
		if (this.value !== "NORMAL") {
			...
			document.getElementById("tessellations").value = 150;
			document.getElementById("tessellations-value").textContent = 150;
		}  
	}
